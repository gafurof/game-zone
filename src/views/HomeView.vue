  ...
  <div class="home-page">
    ...
    <div class="px-4">
      ...
      <div class="section-header">
        ...
        <v-btn variant="text" color="primary" size="x-small" class="pa-0">Hammasi</v-btn>
      </div>

      <v-row dense class="mb-4">
        <v-col v-for="zone in featuredZones" :key="zone.id" cols="6">
      ...
      <div class="section-header mt-4">
        ...
        <v-btn variant="text" color="primary" size="x-small" class="pa-0">Xaritada</v-btn>
      </div>
      ...
      >
        <v-list-item density="compact" class="py-3">
          <template #prepend>
            <v-avatar rounded="circle" color="primary" variant="tonal" size="38">
...
const featuredZones = [
  { id: 1, name: 'CyberPro',  rating: '4.8', distance: '0.3 km', icon: 'mdi-monitor',        iconColor: 'blue',        bg: '#E6F1FB', open: true  },
  { id: 2, name: 'GameHub X', rating: '4.6', distance: '0.7 km', icon: 'mdi-gamepad-variant', iconColor: 'green',       bg: '#EAF3DE', open: true  },
  { id: 3, name: 'VR Arena',  rating: '4.9', distance: '1.1 km', icon: 'mdi-headset',         iconColor: 'amber-darken-2', bg: '#FAEEDA', open: false },
  { id: 4, name: 'EliteZone', rating: '4.7', distance: '1.5 km', icon: 'mdi-trophy-outline',  iconColor: 'deep-purple', bg: '#EEEDFE', open: true  },
]

const activeBrons = [
  { id: 1, icon: 'mdi-monitor',  title: 'CyberPro · Stol #4',    time: 'Bugun, 18:00 – 20:00',   status: 'Faol',       color: 'primary' },
  { id: 2, icon: 'mdi-headset',  title: 'VR Arena · Kabina #1',  time: 'Ertaga, 14:00 – 15:30',  status: 'Kutilmoqda', color: 'warning' },
]
